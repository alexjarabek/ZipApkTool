...
namespace sandGlass
{
    public delegate void ReApkCallBackDelegate(string thread, string msg,Button sender);
    class ReApkTaskThread
    {
        public Button start;
        public Button stop;
                ...
                if (Directory.Exists(gPath))
                {
                    ...
                    foreach (FileInfo fi in allFile)
                    {
                        ...
                        if (FileUtil.checkFile(gameBaseXmlFile))
                        {
                            ...
                            {
                                XmlHelper.mergeResXml(channelXmlFile, gameBaseXmlFile, channelTargetXml); //  合并同名文件
                            }
                        }
                    }
                }
